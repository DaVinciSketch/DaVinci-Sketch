...
// ElasticSketch<bucket_num, tot_memory_in_bytes>::ElasticSketch(int num_bucket, int light_mem_byte){}
...
{
    int sign = 0;
    // cout << "Enter ElasticSketch Insert function" << sign++ << endl;
...
template class ElasticSketch<2400, 614400>;
