...
std::ofstream outfile_set_ops("outputs/setopstasksoutput_diff.csv");
...
void run_difference(int _fermatcount = 2, bool _addundecodec = 1, int array_num = 3, int entry_num = (TOT_MEM_IN_BYTES - HEAVY_MEM)/(3 * 8), bool _fing = 0, int endfile = 0, const std::string &str = NULL){
	...
	Difference<bucket_num>(*sketches[0], *sketches[1], *flcsketch, init_seed);
