...
int main()
{
    ...
    {
        sketches[0] = new FLCSketch<bucket_num>(BUCKET_NUM, array_num, entry_num, _fermatcount, _fing, INIT);
        sketches[1] = new FLCSketch<bucket_num>(BUCKET_NUM, array_num, entry_num, _fermatcount, _fing, INIT);
        true_freqs[0].clear();
        true_freqs[1].clear();
        int allwindowscnt = 1;
